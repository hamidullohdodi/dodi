...
type TransactionServiceClient interface {
	...
	GetTransaction(ctx context.Context, in *GetTransactionReq, opts ...grpc.CallOption) (*TransactionResp, error)
	UpdateTransaction(ctx context.Context, in *UpdateTransactionReq, opts ...grpc.CallOption) (*TransactionResp, error)
	DeleteTransaction(ctx context.Context, in *DeleteTransactionReq, opts ...grpc.CallOption) (*Void4, error)
...
func (c *transactionServiceClient) CreateTransaction(ctx context.Context, in *CreateTransactionReq, opts ...grpc.CallOption) (*TransactionResp, error) {
...
func (c *transactionServiceClient) GetTransaction(ctx context.Context, in *GetTransactionReq, opts ...grpc.CallOption) (*TransactionResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResp)
...
func (c *transactionServiceClient) UpdateTransaction(ctx context.Context, in *UpdateTransactionReq, opts ...grpc.CallOption) (*TransactionResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResp)
...
func (c *transactionServiceClient) DeleteTransaction(ctx context.Context, in *DeleteTransactionReq, opts ...grpc.CallOption) (*Void4, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void4)
...
func (c *transactionServiceClient) ListTransactions(ctx context.Context, in *ListTransactionsReq, opts ...grpc.CallOption) (*ListTransactionsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TransactionServiceServer interface {
	...
	GetTransaction(context.Context, *GetTransactionReq) (*TransactionResp, error)
	UpdateTransaction(context.Context, *UpdateTransactionReq) (*TransactionResp, error)
	DeleteTransaction(context.Context, *DeleteTransactionReq) (*Void4, error)
...
func (UnimplementedTransactionServiceServer) CreateTransaction(context.Context, *CreateTransactionReq) (*TransactionResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTransaction not implemented")
}
func (UnimplementedTransactionServiceServer) GetTransaction(context.Context, *GetTransactionReq) (*TransactionResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransaction not implemented")
}
func (UnimplementedTransactionServiceServer) UpdateTransaction(context.Context, *UpdateTransactionReq) (*TransactionResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTransaction not implemented")
}
func (UnimplementedTransactionServiceServer) DeleteTransaction(context.Context, *DeleteTransactionReq) (*Void4, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteTransaction not implemented")
}
func (UnimplementedTransactionServiceServer) ListTransactions(context.Context, *ListTransactionsReq) (*ListTransactionsResp, error) {
